...
namespace CefSharp
{
    ...
    /// </summary>
    public class ResourceHandlerModified : IResourceHandler
    {
        /// <summary>
        ...
        /// Default Constructor
        /// </summary>
        public ResourceHandlerModified() : this(DefaultMimeType, ResourceHandlerType.Stream)
        {

        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceHandlerModified"/> class.
        /// </summary>
        private ResourceHandlerModified(string mimeType, ResourceHandlerType type)
        {
        ...
        public static ResourceHandlerModified FromFileName(string filePath, string fileExtension = null)
        {
        ...
        /// <summary>
        /// Gets the resource from the file path specified. Use the <see cref="ResourceHandlerModified.GetMimeType"/>
        ...
        /// <returns>ResourceHandler.</returns>
        public static ResourceHandlerModified FromFilePath(string fileName, string mimeType = null)
        {
            return new ResourceHandlerModified(mimeType ?? DefaultMimeType, ResourceHandlerType.File) { FilePath = fileName };
        }
        ...
        /// <param name="fileExtension">The file extension.</param>
        /// <returns>ResourceHandler.</returns>
        public static ResourceHandlerModified FromString(string text, string fileExtension)
        {
        ...
        /// <summary>
        /// Gets a <see cref="ResourceHandlerModified"/> that represents a string.
        ...
        /// <returns>ResourceHandler</returns>
        public static ResourceHandlerModified FromString(string text, Encoding encoding = null, bool includePreamble = true, string mimeType = DefaultMimeType)
        {
            if (encoding == null)
            {
                encoding = Encoding.UTF8;
            }
            return new ResourceHandlerModified(mimeType, ResourceHandlerType.Stream) { Stream = GetMemoryStream(text, encoding, includePreamble) };
        }
        ...
        /// <returns>ResourceHandler.</returns>
        public static ResourceHandlerModified FromStream(Stream stream, string mimeType = DefaultMimeType)
        {
            return new ResourceHandlerModified(mimeType, ResourceHandlerType.Stream) { Stream = stream };
        }
